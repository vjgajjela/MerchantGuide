...
import com.galaxy.utils.MyFilter;
 ...
 * 
 **/
public class MerchanUI extends JFrame implements Action {
	...
	public MerchanUI() {
		...
		this.input.setColumns(getMaximumSize().width / 3);
		...
		this.output.setColumns(getMaximumSize().width / 3);
		...
		add(inputScroll);
		add(outputScroll, BorderLayout.NORTH);
		add(this.chooser, BorderLayout.SOUTH);
		this.chooser.addActionListener(this);
		this.chooser.setSize(getMaximumSize().width / 3, getMaximumSize().height);
		setResizable(true);
